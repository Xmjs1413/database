...
import styles from './IndicatorSidePage.module.less';
...
interface SideProps {
    onContentChange: (item: object) => void;
}

const IndicatorSidePage: React.FC<SideProps> = (props) => {
    ...
    const onSelect = (selectedKeys: any[], info: any) => {
        ...
        if (selectedNode && selectedNode.length > 0 && selectedNode[0].pid !== 0) {
            setIsBorder(true);
            props.onContentChange(selectedNode[0]);
        }
    };
    ...
    return (
        <div className={styles.container}>
            <div className={styles.search}>
                <Search onSearch={onTreeSearch} size="large" />
            </div>
            <div className={isBorder ? styles.border : ''}>
...
export default IndicatorSidePage;
